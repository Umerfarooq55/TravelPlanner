...
class Viater extends StatefulWidget {
  double latdouble;
  String  place;
  String city;
  List l1;
...
class HomeState extends State<Viater> {
...
String urlViater =widget.url.replaceAll("http", "https");
print("URL UMER farooq: "+urlViater);
    return WillPopScope(
        ...
        child: Padding(
          ...
          child: Card(
            ...
            child: new WebviewScaffold(
              url:urlViater,
//                https://www.viator.com/Beijing/d321-ttd/p-67316P156?eap=brand-subbrand-83183&aid=vba83183en
